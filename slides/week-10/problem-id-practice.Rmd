...
For each of the following problems, 
  ...
  c. draw a sketch of an effective visualization, give the name of that type of plot, and provide pseudo R-code to create that plot using ggplot2,
  ...
  g. write out pseudo R code to approximate the null distribution using a computational technique: permutation or simulation (use the same names as is part b).
