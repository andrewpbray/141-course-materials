...
```{r out.height=550, echo = FALSE, out.width = 580}
knitr::include_graphics("figs/midterm-t-test.png")
```
...
```{r out.height=490, echo = FALSE, out.width = 660}
knitr::include_graphics("figs/prius.png")
```
...
knitr::include_graphics("figs/outliers_gladwell.jpg")
```
...
```{r, echo=FALSE, fig.height = 4.3, fig.width = 8.5}
i <- 5
x <- runif(n[i])
y <- m[i]*x + rnorm(n[i])
x <- c(x,xr[[i]])
...
```{r out.height=380, out.width=550, echo = FALSE}
knitr::include_graphics("figs/outliers.png")
```
...
```{r echo = FALSE}
knitr::include_graphics("figs/influenza-a.png")
```
...
```{r echo = FALSE}
knitr::include_graphics("figs/influenza-b.png")
```
