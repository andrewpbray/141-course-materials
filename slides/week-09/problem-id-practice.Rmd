...
For each of the following problems, 
  ...
  - identify the model type (e.g., $X_1 \sim X_2$),
  ...
  - assuming conditions are met, provide the named distribution (e.g., $t(df = 22)$) that could be used to approximate the null distribution.
  - write out pseudo R code to approximate the null distribution using a computational technique: permutation or simulation. Note that you'll have to come up with sensible names for the data set and variables.
